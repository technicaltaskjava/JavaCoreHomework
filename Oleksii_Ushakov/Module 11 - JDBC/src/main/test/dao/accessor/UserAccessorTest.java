...
public class UserAccessorTest {
    ...
    @Test
    public void testGetUserByRegDate() {
        java.sql.Date date = new Date(1462654800000L);

        List<User> userList = accessor.getUserByRegDate(date);
        User user = userList.get(0);

        assertEquals(user.getRegDate(), date);
    }
