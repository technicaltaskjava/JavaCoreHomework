...
import dao.exception.AddCookieException;
import dao.exception.CookiesException;
import dao.exception.NoSuchCookieException;
import dao.exception.UpdateCookieException;
...
public class CookiesAccessor implements AutoCloseable {
    ...
    public void updateCookie(int index, String predication) {
        try (Connection connection = connectionPool.getConnection();
             PreparedStatement statement = connection.prepareStatement("UPDATE Cookies SET predication=? where id=?")) {
    ...
    public void addCookie(String predication) {
        try (Connection connection = connectionPool.getConnection();
             PreparedStatement statement = connection.prepareStatement("INSERT INTO Cookies(predication) VALUES(?)")) {
    ...
    public void addCookie(FortuneCookie fortuneCookie) {
        try (Connection connection = connectionPool.getConnection();
             PreparedStatement statement = connection.prepareStatement("INSERT INTO Cookies(predication, expiration_date, price) VALUES(?, ?, ?)")) {
