...
public class TaskBTest
    {
        ...
        public void testSplitOnWords() throws Exception
            {
               ...
               String [] resoult = splt.splitOnWords("Вася черны Вася кот Вася");
                String [] exp  =  new  String[] {"Вася", "черны", "кот"};
                Assert.assertArrayEquals(resoult,exp);
        ...
        public void testDellPunctuation() throws Exception
            {
                ...
                String resoult = splt.dellPunctuation("Вася, кот. Бобер");
                String exp = "Вася кот Бобер";
        ...
        public void testSplitDubleWords() throws Exception
            {
                String resoult = splt.splitDubleWords("Вася черны Вася кот Вася");
                String exp = "Вася черны кот";
                Assert.assertEquals(resoult, exp);
