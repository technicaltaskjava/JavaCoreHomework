...
public class AirCarrier {
	...
	public List<Aircraft> find(final String model, final int capacity, final int tonnage, final int flyingRange) {
		...
		for (Aircraft aircraft : aircrafts) {
			if (aircraft != null) {
				final boolean flag = isFlag(model, capacity, tonnage, flyingRange, aircraft, true);
				if (flag) {
	...
	private boolean isFlag(final String model, final int capacity, final int tonnage, final int flyingRange, final Aircraft aircraft, boolean flag) {
		boolean isFind = flag;
