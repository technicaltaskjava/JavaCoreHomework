...
public class MainFilterTest {
    ...
    @Test
    public void testDoFilterLogin() throws ServletException {
        when(request.getRequestURI()).thenReturn("/mycookie/view/html/login");
    ...
    @Test
    public void testDoFilterLogout() throws ServletException {
        when(request.getRequestURI()).thenReturn("/mycookie/userlogout");
    ...
    @Test
    public void testDoFilterReg() throws ServletException {
        when(request.getRequestURI()).thenReturn("/mycookie/view/html/registration");
