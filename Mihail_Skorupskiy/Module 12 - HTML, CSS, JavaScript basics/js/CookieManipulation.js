...
var cookies = [
    {id: 1, name: 'First cookie', message: 'Something-something 1'},
    {id: 2, name: 'Second cookie', message: 'Something-something 2'},
    {id: 3, name: 'Third cookie', message: 'Something-something 3'}
];
var currentCookie;
...
function addCookie() {
    var id = document.getElementById('cookie-add-id').value;
    var name = document.getElementById('cookie-add-name').value;
    var message = document.getElementById('cookie-add-message').value;
    cookies[cookies.length] = {id: id, name: name, message: message};
    alert('Cookie added.');
    refresh();
}
...
function findCookie() {
    ...
    for (i = 0; i < cookies.length; i++) {
        if (cookies[i].id == id){
            ...
            document.getElementById('cookie-edit-name').value = cookies[currentCookie].name;
...
function editCookie() {
    cookies[currentCookie].name = document.getElementById('cookie-edit-name').value;
...
function refresh() {
    ...
    table.innerHTML = '<tr class="output"><th>ID</th><th>Cookie</th><th>Message</th></tr>';
    for (i = 0; i < cookies.length; i++){
        if (cookies[i]) {
