...
public class CreateTable {
    ...
    private static String drv = "org.h2.Driver";
    ...
    public static void createTableUsers() {
        try {
            ...
            System.out.println("Table \"Users\" have been created");
    ...
    public static void createTableMetadata() {
        try {
            ...
            st = con.createStatement();
            st.executeUpdate(createTable);
            System.out.println("Table \"Metadata\" have been created");
        } catch (ClassNotFoundException | SQLException e) {
            e.printStackTrace();
            logger.error(e);
        } finally {
    ...
    public static void createTableCookies() {
        try {
            Class.forName(drv);
            ...
            st = con.createStatement();
            st.executeUpdate(createTable);
            System.out.println("Table \"Cookies\" have been created");
        } catch (ClassNotFoundException | SQLException e) {
            logger.error(e);
        } finally {
            try {
